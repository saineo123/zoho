...
public class SwaggerConfig {
    public static final String SWAGGER_INFO_TITLE = "Zoho projects API";
    public static final String SWAGGER_INFO_DESCRIPTION = "This is Zoho API documentation";
    public static final String SWAGGER_INFO_VERSION = "1.0.2";
    public static final String SWAGGER_INFO_CONTACT_NAME = "Iamneo";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "sai.venkat@iamneo.ai";
